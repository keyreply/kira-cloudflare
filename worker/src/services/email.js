...
async function sendEmailViaCloudflare(env, { to, subject, html, text, from, replyTo, tags = [] }) {
  ...
  const fromAddress = from || 'PPP Academy <noreply@ppp-academy.com>';
...
async function sendBatchEmailsViaResend(env, emails) {
  ...
  const payload = emails.map(email => ({
    from: email.from || 'PPP Academy <noreply@ppp-academy.com>',
...
export async function sendWelcomeEmail(env, { to, name, tenantName }) {
  const subject = `Welcome to ${tenantName || 'PPP Academy'}!`;
...
export async function sendPasswordResetEmail(env, { to, name, resetLink, expiresIn = '1 hour' }) {
  const subject = 'Reset Your Password - PPP Academy';
...
export async function sendNotificationDigest(env, { to, name, notifications, tenantId, period = 'daily' }) {
  const subject = `Your ${period} notification digest - PPP Academy`;
...
export async function logEmailSent(env, tenantId, emailData) {
  ...
  try {
    ...
    .bind(
      ...
      tenantId,
      emailData.to,
      emailData.from || 'PPP Academy <noreply@ppp-academy.com>',
      emailData.subject,
...
<head>
  ...
  <title>Welcome to ${tenantName || 'PPP Academy'}</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 40px 30px; text-align: center;">
              <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: 600;">
                Welcome to ${tenantName || 'PPP Academy'}!
              </h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.6; color: #333333;">
                We're thrilled to have you join ${tenantName || 'PPP Academy'}! Your account has been created successfully, and you're all set to get started.
              </p>
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="https://app.ppp-academy.com/dashboard" style="display: inline-block; padding: 14px 32px; background-color: #667eea; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">
                  Get Started
                </a>
              </div>
          ...
          <tr>
            <td style="background-color: #f8f9fa; padding: 30px; text-align: center; border-top: 1px solid #e0e0e0;">
              <p style="margin: 0 0 10px; font-size: 14px; color: #999999;">
                PPP Academy. All rights reserved.
              </p>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.6; color: #333333;">
                <strong>${inviterName}</strong> has invited you to join <strong>${tenantName}</strong> on PPP Academy!
              </p>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              ${isSuccess ? `
              <div style="text-align: center; margin: 30px 0;">
                <a href="https://app.ppp-academy.com/documents" style="display: inline-block; padding: 14px 32px; background-color: #667eea; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">
                  View Document
                </a>
              </div>
              ...
              ` : `
              <div style="text-align: center; margin: 30px 0;">
                <a href="https://app.ppp-academy.com/documents/upload" style="display: inline-block; padding: 14px 32px; background-color: #667eea; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">
                  Try Again
                </a>
              </div>
              `}
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="https://app.ppp-academy.com/notifications" style="display: inline-block; padding: 14px 32px; background-color: #667eea; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">
          ...
          <tr>
            <td style="background-color: #f8f9fa; padding: 30px; text-align: center; border-top: 1px solid #e0e0e0;">
              ...
              <p style="margin: 0; font-size: 12px; color: #999999;">
                ...
                <a href="https://app.ppp-academy.com/settings/notifications" style="color: #667eea; text-decoration: none;">
                  Manage preferences
                </a>
              </p>
            </td>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>${subject || 'PPP Academy'}</title>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f5f5f5; padding: 40px 0;">
    <tr>
