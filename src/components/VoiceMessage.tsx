...
const VoiceMessage = ({ audioSrc, duration, transcript }) => {
  ...
  return (
    <div className="flex flex-col gap-2 max-w-md w-full">
      <div className="bg-white border border-slate-200 rounded-xl p-3 px-4 flex items-center gap-4 shadow-sm">
        <button
          onClick={togglePlay}
        ...
        <div className="flex-1 flex items-center gap-3">
          {/* Custom Slider */}
          <div className="relative flex-1 h-1.5 bg-white rounded-full cursor-pointer group">
            <div
        ...
        <div className="h-6 w-px bg-[#2b303d] mx-1"></div>
      ...
      {showTranscript && (
        <div className="bg-white border border-slate-200 rounded-xl p-4 text-sm text-slate-500 leading-relaxed shadow-sm animate-[slideIn_0.2s_ease-out]">
          {transcript}
        </div>
      )}
    </div>
