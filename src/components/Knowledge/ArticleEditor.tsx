        ...
        <div className="flex flex-1 overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto bg-white">
                ...
                <div className="border-b border-slate-200 px-8 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <button className="px-4 py-2 text-sm font-medium text-slate-600 hover:bg-white rounded-lg transition-colors">
                            Cancel
                        </button>
                        <button className="px-4 py-2 text-sm font-medium bg-slate-900 text-white rounded-lg hover:bg-white transition-colors">
                            Save
                        </button>
                    </div>
                </div>
                ...
                <div className="max-w-3xl mx-auto p-8">
                    ...
                    {/* Editor Toolbar */}
                    <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 bg-white text-white rounded-lg shadow-lg px-4 py-2 flex items-center gap-2">
                        ...
                        <div className="w-px h-6 bg-[#2b303d]"></div>
                        <button className="p-2 hover:bg-slate-200 rounded">
                        ...
                        <div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <label className="relative inline-flex items-center cursor-pointer">
                                    ...
                                    />
                                    <div className="w-11 h-6 bg-[#2b303d] peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-500 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-[#a2a5ad] after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
