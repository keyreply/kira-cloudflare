                ...
                <div className="p-6">
                    {activeTab === 'upload' ? (
                        <div className="space-y-4">
                            <div
                                className={`border-2 border-dashed rounded-xl p-8 flex flex-col items-center justify-center text-center cursor-pointer transition-colors ${file ? 'border-blue-200 bg-blue-50' : 'border-slate-200 hover:border-blue-300 hover:bg-white'
                                    }`}
                            ...
                            >
                                ...
                                {file ? (
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-600 mt-1">PDF, DOCX, TXT up to 10MB</p>
                                    </div>
                                )}
                            </div>
                        </div>
