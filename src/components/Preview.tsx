    ...
    return (
        <div className="flex-1 flex bg-white">
            <div className="flex-1 flex items-center justify-center p-8">
                <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden border-8 border-slate-100">
                        ...
                        {previewMessages.map((msg, index) => (
                            <div key={index} className={`flex gap-2 mb-3 ${msg.sender === 'user' ? 'flex-row-reverse' : ''}`}>
                                <div className={`max-w-[75%] p-3 rounded-2xl text-sm ${msg.sender === 'kira'
                                        ? 'bg-white text-[#1d212a] rounded-tl-none'
                    ...
                    <div className="p-3 bg-white border-t border-slate-200">
                        <div className="flex gap-2">
                            <input
                                type="text"
                                className="flex-1 p-2.5 px-4 bg-white border-none rounded-full text-sm outline-none"
                            ...
                            />
                            <button
                                className="w-10 h-10 bg-blue-500 border-none rounded-full text-white cursor-pointer transition-all duration-150 hover:bg-blue-600 disabled:bg-[#a2a5ad]"
            ...
            <div className="w-[400px] bg-white border-l border-slate-200 p-6">
                ...
                {previewMode === 'kira' && (
                    <div className="mb-6">
                        ...
                        <textarea
                            className="w-full p-3 bg-white border border-slate-200 rounded-lg text-sm resize-none outline-none focus:border-blue-500"
                        ...
                        />
                        <button
                            className="w-full mt-2 py-2.5 px-4 bg-blue-500 border-none rounded-lg text-white font-medium cursor-pointer transition-all duration-150 hover:bg-blue-600 disabled:bg-[#a2a5ad] disabled:cursor-not-allowed"
