    ...
    return (
        <div className="inline-flex flex-col gap-2 my-2">
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2.5 bg-white hover:bg-white text-slate-600 border border-[#a2a5ad] rounded-lg font-medium text-sm transition-all duration-150 hover:shadow-sm no-underline"
            >
