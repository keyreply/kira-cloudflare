...
export default function CreateTask({ onClose, onSave }) {
    ...
    const renderStepIndicator = () => (
        <div className="flex items-center justify-center gap-3 mb-8">
            <div className={`flex items-center justify-center w-12 h-12 rounded-lg ${currentStep === 1 ? 'bg-slate-900 text-white' : 'bg-[#2b303d] text-slate-500'} font-medium`}>
                01
            </div>
            ...
            <div className="w-8 h-px bg-[#a2a5ad] mx-2"></div>

            <div className={`flex items-center justify-center w-12 h-12 rounded-lg ${currentStep === 2 ? 'bg-slate-900 text-white' : 'bg-[#2b303d] text-slate-500'} font-medium`}>
                02
            </div>
            ...
            <div className={`flex items-center justify-center w-12 h-12 rounded-lg ${currentStep === 3 ? 'bg-slate-900 text-white' : 'bg-[#2b303d] text-slate-500'} font-medium`}>
                03
            </div>
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <input
                    ...
                    maxLength={100}
                    className="w-full px-4 py-2 border border-[#a2a5ad] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <div className="flex justify-between mt-1">
                    <p className="text-xs text-slate-500">Recommended to reflect activity purpose and scenario</p>
                    <p className="text-xs text-slate-500">{formData.taskName.length}/100</p>
                </div>
            </div>
            ...
            <div>
                ...
                {formData.targetUsers === 'database' && (
                    <div>
                        ...
                        <div className="border border-[#a2a5ad] rounded-lg p-4 bg-white">
                            <div className="flex items-center justify-between mb-3">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button className="px-3 py-1 bg-slate-900 text-white text-sm rounded-lg hover:bg-white">Confirm</button>
                                </div>
                            </div>

                            <div className="flex flex-wrap gap-2 mb-3">
                                <span className="px-3 py-1 bg-white border border-[#a2a5ad] rounded-full text-sm">Active User</span>
                                <span className="px-3 py-1 bg-white border border-[#a2a5ad] rounded-full text-sm">Hyperglycemia</span>
                                <span className="px-3 py-1 bg-white border border-[#a2a5ad] rounded-full text-sm">Long time no exam</span>
                                <button className="w-6 h-6 flex items-center justify-center text-slate-500 hover:text-slate-600 text-xl">+</button>
                            </div>
                        ...
                        {['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'].map(day => (
                            <label key={day} className="flex items-center gap-2">
                                <input
                                    ...
                                    className="w-4 h-4 rounded border-[#a2a5ad] text-blue-600 focus:ring-blue-500"
                                />
                                <span className="text-sm text-slate-600 capitalize">{day}</span>
                            </label>
                        ))}
                    </div>
                ...
                <div className="mb-4">
                    ...
                    <div className="flex gap-2">
                        <input
                            ...
                            className="flex-1 px-4 py-2 border border-[#a2a5ad] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                        <select
                            value={formData.latestTriggerUnit}
                            onChange={(e) => updateFormData('latestTriggerUnit', e.target.value)}
                            className="px-4 py-2 border border-[#a2a5ad] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
                            <option>Hours</option>
                            <option>Days</option>
                        </select>
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start justify-between">
                ...
                <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${formData.antiHarassment ? 'bg-slate-900' : 'bg-[#a2a5ad]'
                        }`}
                >
                    <span
            ...
            <div className="border-t border-slate-200 pt-6 space-y-4">
                ...
                <div className="flex items-start justify-between">
                    ...
                    <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${formData.mandatoryExitScript ? 'bg-slate-900' : 'bg-[#a2a5ad]'
                            }`}
                    >
                        <span
                ...
                <div className="flex items-start justify-between">
                    ...
                    <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${formData.sensitiveWordFilter ? 'bg-slate-900' : 'bg-[#a2a5ad]'
                            }`}
                    >
                        <span
                ...
                <div className="flex items-start justify-between">
                    ...
                    <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${formData.multiLanguageCompliance ? 'bg-slate-900' : 'bg-[#a2a5ad]'
                            }`}
                    >
                        <span
            ...
            <div className="border-t border-slate-200 pt-6 space-y-4">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows={3}
                        maxLength={700}
                        className="w-full px-4 py-2 border border-[#a2a5ad] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
                    />
        ...
        <div className="flex-1 flex flex-col bg-white">
            ...
            <div className="bg-white px-8 py-4 border-t border-slate-200">
                <div className="max-w-4xl mx-auto flex items-center justify-end gap-3">
                    <button
                        onClick={onClose}
                        className="px-6 py-2 text-sm font-medium text-slate-600 hover:bg-white rounded-lg transition-colors"
                    >
                        Cancel
                    </button>
                    {currentStep > 1 && (
                        <button
                            ...
                            className="px-6 py-2 text-sm font-medium text-slate-600 border border-[#a2a5ad] hover:bg-white rounded-lg transition-colors"
                        >
                            Previous
                        </button>
                    )}
                    {currentStep < 3 ? (
                        <button
                            onClick={handleNext}
                            className="px-6 py-2 bg-slate-900 text-white text-sm font-medium rounded-lg hover:bg-white transition-colors"
                        >
                            Next
                        </button>
                    ) : (
