                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
                        <div className="flex justify-between items-start mb-6">
                            ...
                            <div className="flex items-center gap-3">
                                <span className="text-sm font-medium text-slate-600">Enable SMS</span>
                                <button
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium text-slate-600 mb-1">Account SID</label>
                                <input
                                    type="text"
                                    value={accountSid}
                                    onChange={(e) => setAccountSid(e.target.value)}
                                    className="w-full px-3 py-2 border border-[#a2a5ad] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                                />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-slate-600 mb-1">Auth Token</label>
                                <input
                                    type="password"
                                    value={authToken}
                            ...
                            <div>
                                <label className="block text-sm font-medium text-slate-600 mb-1">From Number / Sender ID</label>
                                <input
                                    type="text"
                                    value={fromNumber}
