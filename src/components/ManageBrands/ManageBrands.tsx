        ...
        <div className="flex-1 flex flex-col h-full bg-white font-sans">
            ...
            <header className="bg-white border-b border-slate-200 h-16 px-6 flex items-center justify-between shrink-0">
                <div className="flex items-center gap-8 flex-1">
                    <h1 className="text-lg font-bold text-white">Brands</h1>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="p-1 text-slate-600 hover:bg-white rounded-full transition-colors">
            ...
            <main className="flex-1 p-8 overflow-y-auto">
                <div className="max-w-5xl mx-auto space-y-6">
                    <div>
                        <h2 className="text-2xl font-bold text-white mb-2">Manage brands</h2>
                        <p className="text-slate-500">Create and manage brands to customize your customer experience across different products or regions</p>
                    </div>

                    {/* Brands List */}
                    <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
                        <div className="grid grid-cols-12 gap-4 px-6 py-3 bg-white border-b border-slate-200 text-xs font-semibold text-slate-600 uppercase tracking-wider">
                        ...
                        <div className="divide-y divide-slate-100">
                            {filteredBrands.map((brand) => (
                                <div
                                    ...
                                    className="grid grid-cols-12 gap-4 px-6 py-4 items-center hover:bg-white cursor-pointer transition-colors group"
                                >
                                    <div className="col-span-9 flex items-center gap-4">
                                        ...
                                        <div>
                                            <div className="font-semibold text-white group-hover:text-blue-600 transition-colors">{brand.name || 'Untitled Brand'}</div>
                                            <div className="text-sm text-slate-600">AI Agent: {brand.agent === 'Fin' ? 'Kira' : brand.agent}</div>
                                        </div>
                                    </div>
