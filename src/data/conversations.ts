...
export const allConversationData: Conversation[] = [
    // ========== Use Case I-1: Kevin - Day 0 Activation ==========
    {
        ...
        steps: [
            ...
            // Branch 3: "Who is this?"
            {
                ...
                type: "kira",
                content: "Apologies, it's Chris Chan (KeyReply). Updating my contacts and wanted to see how your Q4 momentum is holding up. Good time to chat?",
                time: "10:08 AM",
                options: [
                    { text: "Yes, what's up?", type: "positive" },
                    { text: "Not now", type: "negative" }
